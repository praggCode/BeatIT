    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-md">
            <div className="glass max-w-sm w-full relative overflow-hidden animate-in fade-in zoom-in duration-200"
                style={{
                    boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px var(--glass-border-2)',
                }}>
                ...
                <div className="p-8 pb-6 text-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            ...
                            style={{
                                background: loading || !email || !password ? 'var(--glass-bg-4)' : 'linear-gradient(135deg, var(--accent) 0%, #4f46e5 100%)',
